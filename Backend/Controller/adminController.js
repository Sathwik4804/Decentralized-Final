...
export const addAdmin = async (req, res) => {
    try {
        ...
        console.log(`[Admin Created] To: ${emailId}, Subject: You have been added as Admin, Message: Hello ${name}, You have been added as an Admin. Please visit the system to setup your password.`);
